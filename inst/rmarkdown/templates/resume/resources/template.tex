...
\flushleft{\Large \sffamily \bfseries $author$}
...
$if(twitter)$
\usepackage{ifthen} % Ensure this is in the preamble
\ifthenelse{\equal{$twitter$}{}}{}{%
  $if(fontawesome)$\faTwitter \hspace{1 mm}$else$\emph{Twitter:}$endif$ \href{http://twitter.com/$twitter$}{\tt $twitter$} \hspace{1 mm}
}
$endif$
