...
\moveleft.5\hoffset\centerline{$if(waddress)$ $waddress$ $endif$ $if(wemail)$$if(fontawesome)$\faEnvelopeO \hspace{1 mm}$else$\emph{E-mail:}$endif$ \href{mailto:}{\tt $wemail$} \hspace{1 mm}$endif$ $if(wphone)$$if(fontawesome)$ \faPhone \hspace{1 mm}$else$\emph{Phone:}$endif$ $wphone$ \hspace{1 mm} $endif$} 

\moveleft.5\hoffset\centerline{$if(paddress)$ $paddress$ $endif$ $if(pemail)$$if(fontawesome)$\faEnvelopeO \hspace{1 mm}$else$\emph{E-mail:}$endif$ \href{mailto:}{\tt $pemail$} \hspace{1 mm}$endif$ $if(pphone)$$if(fontawesome)$ \faPhone \hspace{1 mm}$else$\emph{Phone:}$endif$ $pphone$ \hspace{1 mm} $endif$} 
