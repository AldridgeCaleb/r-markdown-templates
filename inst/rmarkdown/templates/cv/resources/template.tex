...
$endif$\\
$if(pemail)$
\faEnvelopeO \hspace{1 mm} \texttt{\href{mailto:$pemail$}{$pemail$}} \hspace{1 mm}
$endif$\\
$if(pphone)$
\faPhone \hspace{1 mm} $pphone$ \hspace{1 mm}
$endif$\\
$if(pweb)$
\faGlobe \hspace{1 mm} \texttt{\href{http://$pweb$}{$pweb$}} \hspace{1 mm}
$endif$
...
$endif$\\
$if(wemail)$
\faEnvelopeO \hspace{1 mm} \texttt{\href{mailto:$wemail$}{$wemail$}} \hspace{1 mm}
$endif$\\
$if(wphone)$
\faPhone \hspace{1 mm} $wphone$ \hspace{1 mm}
$endif$\\
$if(wweb)$
\faGlobe \hspace{1 mm} \texttt{\href{http://$wweb$}{$wweb$}} \hspace{1 mm}
$endif$
\end{multicols}
