...
\fancypagestyle{firstpage}{
  ...
  \lhead{}
  \chead{}
  \rhead{$if(updated)$ \emph{Updated:} \today$endif$} % Customize right header for first page
  %$if(updated)$ | \emph{Updated:} $if(rdateformat)$$rdateformat$$else$\apstylekinda\today$endif$$endif$
  \lfoot{\scriptsize $initials$}
  \cfoot{}
...
\moveleft.5\hoffset\centerline{$if(waddress)$\moveleft.5\hoffset\centerline{$waddress$}$endif$ $if(wemail)$$if(fontawesome)$\faEnvelopeO \hspace{1 mm}$else$\emph{E-mail:}$endif$ \href{mailto:}{\tt $wemail$} \hspace{1 mm}$endif$ $if(wphone)$$if(fontawesome)$ \faPhone \hspace{1 mm}$else$\emph{Phone:}$endif$ $wphone$ \hspace{1 mm} $endif$} 

\moveleft.5\hoffset\centerline{$if(paddress)$\moveleft.5\hoffset\centerline{$paddress$}$endif$ $if(pemail)$$if(fontawesome)$\faEnvelopeO \hspace{1 mm}$else$\emph{E-mail:}$endif$ \href{mailto:}{\tt $pemail$} \hspace{1 mm}$endif$ $if(pphone)$$if(fontawesome)$ \faPhone \hspace{1 mm}$else$\emph{Phone:}$endif$ $pphone$ \hspace{1 mm} $endif$} 
